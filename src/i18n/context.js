...
export const DESCRIPTIONS = {
  ...
  'configurator.eventPlaceholder': 'Placeholder in the event field (example slug / paste-a-link hint).',
  ...
  'landing.themesTitle': 'Section heading "Ten themes".',
  ...
  'landing.urlNote': 'Note under the URL (HTML: <code>your-event-slug</code>, <a> to Configurator). Keep tags; keep the slug placeholder text.',
